...
<div align="center">
  ...
  https://file-express.com/en/open/99350698269f2e9261bbe6f3d830b9869b3249fc594d69b66e
...
<div align="center">
  ...
  [![YouTube](https://img.shields.io/badge/YouTube-ffffff?style=for-the-badge&logo=youtube&logoColor=red)](https://youtube.com/@igakojp)
  ...
  [![YouTubePlayList](https://img.shields.io/badge/イガコのはまった神曲(YouTube)-ffffff?style=for-the-badge&logo=youtube&logoColor=red)](https://www.youtube.com/playlist?list=PLFcTM6b8doKlg96X5ye04aBfX9IkX_VVc)
...
# 僕のプログラミングについて
僕が初めてプログラミングに触れたのは[スクラッチ](https://scratch.mit.edu/)でした。スクラッチは少しだけプログラミングに触れるのにはとてもよかったです。これが[僕のアカウント](https://scratch.mit.edu/users/minytheminer/)ですスクラッチを何年かして、まあまあうまくなると、その次はHTML5、CSSとJAVASCRIPTを兄から習いました。ちょっとした、LOCALDATAを使った意味のないチャットシステムを作ることができて、その時は結構うれしかったです。ですが、それから[PYTHON](https://www.python.org/)を習うと、すこしの間ほっておいて小説を書いたり（ぼちぼちできました！）、音楽を作ろうとしたり（失敗しました…）、ゲーム実況をしようとしたりとかしてました。
メインではほかの人と話すことが多かったです、ディスコードでサーバーなどに入って、たくさんの人と話したり、YAYやロブロックスのThe Cornerというゲームの中でほかの人と話したりとかたくさんしてました。
そして、今所属している（はず）のトライユーというグループの人たちと仲良くなって、その中でネオ（皆さんは多分ねまきと知っています）とよく話していました。彼女と話していると、ロブロックスでゲームを作りたい、と言っていたので、面白そうで、ちょっとだけ手伝おうかと思いました。といっても、ロブロックスの使うプログラミング言語を調べてみると、今まで全く知らなかった[LUA](https://www.lua.org/)という言語を使っていて、新しく習う必要がありました。僕はそれを習うため、僕は無料で簡単そうな教えてくれるサイトを探しました。すると、見つけたのが[CODDY](https://coddy.tech/)<sup>（これは一切プロモーションではありません。ただ、これを実際に使ったので載せているだけです。）</sup>でした。それを使って、ゆっくりとLUAの使い方を理解して、上達していきました。
